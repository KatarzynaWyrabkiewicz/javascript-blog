...
function addClickListenersToTags(){
  ...
  for (let oneLink of allLinksToTag) {
...
function generateAuthors(){
  ...
  for (let article of articles) {
    ...
    const linkHTML = templates.authorLink(linkToHTMLData);
    html = html + linkHTML;
    //html = html + linkHTML;
  ...
  for (let author in allAuthors) {
    allAuthorsHTML.authors.push({author: author});
  ...
  authorsList.innerHTML = templates.authorCludLink(allAuthorsHTML);
}
...
function authorClickHandler(event) {
  ...
  for (let oneLink of authorLinksHref) {
...
function addClickListenerstoAuthors(){
  ...
  for (let oneAuthorsLink of allAuthorsLinks) {

    /* add event listener to every authorsLink */
    oneAuthorsLink.addEventListener('click', authorClickHandler);
  }
}
